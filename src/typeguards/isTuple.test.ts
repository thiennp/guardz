...
describe('isTuple', () => {
  ...
  describe('error handling', () => {
    ...
    it('should not call error callback for valid tuples', () => {
      ...
      const config = { identifier: 'coordinate', callbackOnError: mockCallback };
    ...
    it('should call error callback for non-arrays', () => {
      ...
      expect(mockCallback).toHaveBeenCalledWith('Expected coordinate ("not an array") to be "array"');
    });
    ...
    it('should call error callback for wrong length', () => {
      ...
      expect(mockCallback).toHaveBeenCalledTimes(1);
      expect(mockCallback).toHaveBeenCalledWith('Expected coordinate ([\n  10\n]) to be "tuple of length 2, but got length 1"');
    });
  ...
  describe('real-world use cases', () => {
    it('should validate coordinate pairs', () => {
      const isCoordinate = isTuple(isNumber, isNumber);
      const validCoordinates = [[0, 0], [10.5, -20.3], [100, 200]];
      const invalidCoordinates = [[10], [10, 20, 30], ['10', 20], [null, undefined]];
